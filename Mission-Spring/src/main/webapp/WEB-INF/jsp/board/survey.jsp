      ...
      <nav class="navbar navbar-dark fixed-top navbar-expand-md navbar-no-bg">
         <div class="container">
            <a class="navbar-brand" href="${ pageContext.request.contextPath }">
             ...
             <div class="collapse navbar-collapse" id="navbarNav"  style="position: absolute; left:32%; ">
                 <ul class="navbar-nav ml-auto"  >
                     <li class="nav-item"  >
                         <a class="nav-link" href="#top-content"  >Top</a>
                     </li>
                     <li class="nav-item">
                         <a class="nav-link" href="${ pageContext.request.contextPath }/login">ABOUT US</a>
                     </li>
                     <li class="nav-item">
                         <a class="nav-link" href="${ pageContext.request.contextPath }/login">SIGN IN</a>
                     </li>
                     <li class="nav-item">
                         <a class="nav-link" href="#section-3">Item 3</a>
                     </li>
                     <li class="nav-item">
                         <a class="nav-link" href="#section-4">Item 4</a>
                     </li>
                 </ul>
             </div>
          </div>
