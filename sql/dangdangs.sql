...
create sequence d_symptom_seq nocache;
...
create sequence d_weaken_seq nocache;
...
create sequence d_pet_seq nocache;
...
create sequence d_comment_seq nocache;
...
-- admin 계정
insert into d_member values(d_member_seq.nextval, 'admin', 'admin', '운영자', 'S');
commit;
